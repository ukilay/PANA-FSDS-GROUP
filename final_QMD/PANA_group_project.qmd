...
We, **PANA**, pledge our honour that the work presented in this assessment is our own. Where information has been derived from other sources, we confirm that this has been indicated in the work. Language Models such as Chatgpt has been used to check spelling, punctuation and grammar.
...
files_to_download = {
    "https://raw.githubusercontent.com/ukilay/PANA-FSDS-GROUP/main/final_QMD/bio.bib": "bio.bib",
    "https://raw.githubusercontent.com/ukilay/PANA-FSDS-GROUP/main/final_QMD/harvard-cite-them-right.csl": "harvard-cite-them-right.csl"
}

# Loop through each file and download
for url, output_file in files_to_download.items():
    try:
        ...
        # Uncomment to confirm successful download
        # print(f"File downloaded successfully as {output_file}")
    except requests.exceptions.RequestException as e:
        # Uncomment to see errors during download
        # print(f"An error occurred while downloading {output_file}: {e}")
        pass  # Ensure no syntax errors if except block is empty
```
...
host_data = host_data[host_data["year"].isin(target_years)]
